...
const Level7 = () => {
  ...
  const fetchServices = async (
    pageUrl = `http://195.35.37.105:200/api/level7/video?page=${currentPage}`
  ) => {
    const params = {
      // dataLimit: 3,
    };
  ...
  return (
    <section className="pt-4 pb-12 bg-gray-50 mt-20 px-4" dir="rtl">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800">Level 7</h2>
        <p className="mt-4 text-gray-600">انضم لمجتمعنا المتميز</p>
      </div>
          ...
          services.map((service) => (
            ...
            >
              <video
                ...
                alt={service.name} // Note: video elements don't use alt attribute, so you can keep this comment for clarity
                muted
                loop
                playsInline
                controls={false} // Set to false to hide controls if you want it stopped
              />
